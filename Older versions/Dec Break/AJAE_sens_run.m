...
farm=.22195 %area of aquifer farmed NOTE NEED TO WATCH INITIAL DRYLAND FIX IN PROFIT FILE. 
...
for i=1:size(x2,2)-1
[pi_tot_myop(i), pi_dry_myop(i), pi_irr_myop(i)]=pi_total_yield(myop(i),rn(i),c0,c1,ps,pc,pw,irrig(A,max_k,min_k,x2(i),farm,init_k),A,x2(i),farm);
[pi_tot_op(i), pi_dry_op(i), pi_irr_op(i)]=pi_total_yield(w_d(i),rn(i),c0,c1,ps,pc,pw,irrig(A,max_k,min_k,x4(i),farm,init_k),A,x4(i),farm);
end
