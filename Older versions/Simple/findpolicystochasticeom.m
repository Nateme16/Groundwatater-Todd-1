function [policyopt valuefit alpha policy policyint v X u1 ] = findpolicystochasticeom(n,beta,r,k,g,c0,c1,A,rec,S,re,max_k,min_k,tol,maxit,P)
...
profitnonirr=@(r) ((((r.^2)/(2.*k) )- ((g.*r)./k))).*.3 %Proft non-irrigated
