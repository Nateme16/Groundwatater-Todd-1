...
farm=.17 %.17 %area of aquifer farmed (irrigated+dryland) %area of aquifer farmed NOTE NEED TO WATCH INITIAL DRYLAND FIX IN PROFIT FILE. 

c0=0  %fixed pump cost
c1=(.1044) %variable pump cost
A= 2190000 %Area of aquifer
rec=.06%131400    %Aquifer Recharge
S=.17   %Storitivity
re=.2   %percent return
